                    ...
                    |> Expect.equal
                        ...
                        , effect =
                            Components.Skill.Buff
                                ...
                                , duration = Just (newRange 0 1000 1000)
                                }
                        }
    ...
    describe "Color tests"
        [ test "Create a new color with default values" <|
            \_ ->
                testColor
                    |> Expect.equal
                        { hue = newRange 0 0 360
                        , saturation = newRange 0 100 100
                        , lightness = newRange 0 50 100
                        }
        , test "Set hue of init color to 120 (green)" <|
            \_ ->
                Components.Color.withHue 120 testColor
                    |> Expect.equal
                        { hue = newRange 0 120 360
            ...
            \_ ->
                testBuff
                    ...
                    |> Expect.equal
                        ...
                        , description = "A buff"
                        , effects = [ Components.Stat.powerStat 3 ]
                        , duration = Just (newRange 0 990 1000)
                        }
